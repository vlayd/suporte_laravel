<!-- Modal -->
<div class="modal modal-lg fade" id="categoriaModal" tabindex="-1" role="dialog" aria-labelledby="categoriaModalLabel" aria-hidden="true">
            ...
            <form id="form_save">
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="col-6">
                            <label class="form-label mt-3">Setor</label>
                            <select name="setorModal" class="form-control">
